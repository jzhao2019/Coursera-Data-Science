...
```{r}
pollutantmean("~/R Works/Course 2/specdata","sulfate", 1:10)
```

```{r}
pollutantmean("~/R Works/Course 2/specdata","nitrate", 70:72)
```


```{r}
pollutantmean("~/R Works/Course 2/specdata","nitrate", 23)
```
...
```{r}
complete("~/R Works/Course 2/specdata",1)
```

```{r}
complete("~/R Works/Course 2/specdata",c(2, 4, 8, 10, 12))
```

```{r}
complete("~/R Works/Course 2/specdata",30:25)
```

```{r}
complete("~/R Works/Course 2/specdata",3)
```
...
```{r}
cr <- corr("~/R Works/Course 2/specdata", 150)
head(cr)
```
...
```{r}
cr <- corr("~/R Works/Course 2/specdata", 400)
head(cr)
```
...
```{r}
cr <- corr("~/R Works/Course 2/specdata", 5000)
summary(cr)
```
...
```{r}
cr <- corr("~/R Works/Course 2/specdata")
summary(cr)
```
